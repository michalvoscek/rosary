...
export const prayers: Record<string, BilingualText> = {
  ...
  apostlesCreed: {
    sk: 'Verím v Boha, Otca všemohúceho, Stvoriteľa neba i zeme, i v Ježiša Krista, jeho jediného Syna, nášho Pána, ktorý sa počal z Ducha Svätého, narodil sa z Márie Panny, trpel pod Pontským Pilátom, bol ukrižovaný, umrel a bol pochovaný, zostúpil do pekla, tretieho dňa vstal z mŕtvych, vystúpil na nebesia, sedí po pravici Boha, Otca všemohúceho, odtiaľ príde súdiť živých i mŕtvych. Verím v Ducha Svätého, vo svätú cirkev všeobecnú, v spoločenstvo svätých, v odpustenie hriechov, vo vzkriesenie tela a v život večný. Amen.',
  ...
  hailMaryFull: {
    sk: 'Zdravas Mária, milosti plná, Pán s tebou, požehnaná si medzi ženami a požehnaný je plod života tvojho, Ježiš. Svätá Mária, Matka Božia, pros za nás hriešnych, teraz i v hodine smrti našej. Amen.',
  ...
  gloryBe: {
    sk: 'Sláva Otcu i Synu i Duchu Svätému, ako bolo na počiatku, tak nech je teraz i vždycky a na veky vekov. Amen.',
  ...
  fatimaPrayer: {
    sk: 'Ježišu môj, odpusť nám naše hriechy, zachráň nás od pekelného ohňa, prievezmi do neba všetky duše, najmä tie, ktoré najviac potrebujú tvoje milosrdenstvo.',
