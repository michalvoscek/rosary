...
export const mysteryMeditations: Record<string, MysterySetTexts> = {
  ...
  sorrowful: {
    ...
    decade2: { sk: 'ktorý bol pre nás bičovaný', en: 'who was scourged for us' },
    decade3: { sk: 'ktorý bol pre nás tŕním korunovaný', en: 'who was crowned with thorns for us' },
    decade4: { sk: 'ktorý pre nás kríž niesol', en: 'who carried the heavy cross for us' },
    decade5: { sk: 'ktorý bol pre nás ukrižovaný', en: 'who died on the cross for us' },
  },
  glorious: {
    ...
    decade4: { sk: 'ktorý ťa, Panna, vzal do neba', en: 'who took Mary into heaven' },
  ...
  luminous: {
    ...
    decade1: { sk: 'ktorý bol pokrstený v Jordáne a začal svoje verejné účinkovanie', en: 'who was baptized for us' },
    ...
    decade4: { sk: 'ktorý sa ukázal v božskej sláve na vrchu premenenia', en: 'who was transfigured before the apostles' },
    decade5: { sk: 'ktorý nám dal seba samého za pokrm a nápoj v Oltárnej sviatosti', en: 'who gave us the Eucharist' },
  },
};
